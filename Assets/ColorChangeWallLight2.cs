...
public class ColorChangeWallLight2 : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        float defaultRed = 0.0f;  // Oletusarvo punaiselle v‰riarvolle
        float defaultGreen = 0.0f;  // Oletusarvo vihre‰lle v‰riarvolle
        float defaultBlue = 0.0f;  // Oletusarvo siniselle v‰riarvolle
